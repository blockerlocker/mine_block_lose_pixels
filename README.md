...
To reset your screen back to normal, simply run `/function mine_block_lose_pixels:reset`

Post effects were added in the snapshots for 26.3, so do not expect this pack to work in past versions.
